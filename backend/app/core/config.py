...
class Settings(BaseSettings):
    ...
    blockchain_network_config: Optional[str] = os.getenv("BLOCKCHAIN_NETWORK_CONFIG", None)
    blockchain_user_name: Optional[str] = os.getenv("BLOCKCHAIN_USER_NAME", None)
    blockchain_org_name: Optional[str] = os.getenv("BLOCKCHAIN_ORG_NAME", None)
