...
from app.api.v1.endpoints import auth, cases, dashboard, officers, teams, atms, predictions, graph, freeze, reports, public, audit, blockchain_monitor
...
api_router.include_router(blockchain_monitor.router, prefix="/predictions", tags=["Blockchain Monitoring"])
